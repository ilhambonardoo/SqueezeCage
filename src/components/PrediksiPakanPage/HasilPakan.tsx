    ...
    <>
      ...
      {dataPrediksi && !isLoading && (
        <div className="flex flex-col gap-6 animate-fadeIn">
                  ...
                  {dataPrediksi.daftarHewan.map(
                    (hewan: HewanPrediksiItem, idx: number) => (
                      <li
                        ...
                        className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-2 hover:bg-neutral-900/30 transition-colors"
                      >
                        <div className="flex items-center gap-3">
                          <span className="text-xs font-semibold px-2 py-1 bg-neutral-800 text-neutral-400 rounded-md">
                            {idx + 1}
                          </span>
                          <div>
                            ...
                            <p className="text-xs text-neutral-500 flex items-center gap-1.5 mt-0.5">
                              ...
                              <span>•</span>
                              <span className="text-amber-600/90 font-medium flex items-center gap-0.5">
                                <Activity size={10} />{" "}
                                {hewan.status_fisiologi ||
                                  hewan.status_fisiologi}
                              </span>
                            </p>
                          </div>
                        ...
                        <div className="text-xs sm:text-sm text-neutral-400 bg-neutral-900/70 px-3 py-1.5 rounded-lg border border-neutral-800 font-medium self-start sm:self-center">
                          💡 ML Predict:{" "}
          ...
          {dataPrediksi.daftarHewan.length > 0 && (
            <div className="bg-linear-to-br from-amber-950/20 to-neutral-900/50 border border-amber-900/30 p-6 rounded-2xl shadow-md">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-neutral-950/50 border border-neutral-800 p-4 rounded-xl flex flex-col gap-1">
